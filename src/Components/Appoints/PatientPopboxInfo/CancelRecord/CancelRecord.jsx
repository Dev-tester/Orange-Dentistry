...
class CancelRecord extends React.Component {
	...
	saveRecord(evt) {
		...
		$.post("shedule/cancelrecord", form, function (response){
	...
	render() {
		let patient = this.props.patient,
			hasDetails = this.state.reason == 'Отказ от приёма' || this.state.reason == 'Отказ от лечения';
		return (
