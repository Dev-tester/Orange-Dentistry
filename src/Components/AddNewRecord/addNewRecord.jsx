					...
					<div className="col-lg-12">
						<div className="container">
							<div className="row mt-lg-3 mb-lg-3 headers">
								...
								<div className="col-lg-4 input-name">
									<span>Время:</span>
									<strong>{appoint.time} - {appoint.nextTime} (0:30)</strong>
								</div>
							</div>
							<div className="row">
								...
								<div className="col-lg-7 right-col">
									...
									<div className="row">
										<div className="col-lg-4 input-name">Страховая компания</div>
										<div className="col-lg-8">
											<input
								...
								<div className="col-lg-4 offset-lg-4 mt-lg-3">
									<button
										onClick={this.props.saveRecord.bind(this, this.state, appoint)}
